...
class GhostModule(nn.Module):
    def __init__(self, inp, oup, kernel_size=1,  stride=2, ratio=2, dw_size=3, relu=True):
...
#     model = GhostModule(inp=32, oup=64, kernel_size=1,  stride=2)
#
...
class CAGSNet(nn.Module):
    ...
    def __init__(self, classes=19, M=3, N=21, dropout_flag=False):
        ...
        self.level1_0 = GhostModule(inp=3, oup=32,  stride=2)
        # self.level1_1 = ConvBNPReLU(32, 32, 3, 1)
        self.level1_1 = GhostModule(inp=32, oup=32, stride=1)

        # self.level1_2 = ConvBNPReLU(32, 32, 3, 1)
        self.level1_2 = GhostModule(inp=32, oup=32, stride=1)
