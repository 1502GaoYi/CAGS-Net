...
class CAGSNet(nn.Module):
    ...
    def __init__(self, classes=19, M=3, N=21, dropout_flag=False):
        ...
        self.level1_0 = CondConv2D(in_channels=3, out_channels=32, stride=2)
        # self.level1_1 = ConvBNPReLU(32, 32, 3, 1)
        self.level1_1 = CondConv2D(in_channels=32, out_channels=32, stride=1)

        # self.level1_2 = ConvBNPReLU(32, 32, 3, 1)
        self.level1_2 = CondConv2D(in_channels=32, out_channels=32, stride=1)
