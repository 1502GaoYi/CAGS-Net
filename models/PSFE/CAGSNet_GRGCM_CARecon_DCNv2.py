...
# 测试代码
def main():
    # 随机生成输入张量, 假设batch_size=1, 通道数=3, 高度和宽度=64
    input_tensor = torch.randn(1, 35, 64, 64)

    # 初始化DCNv2卷积层, 输入通道为3，输出通道为16，卷积核大小为3
    dcn = DCNv2(in_channels=35, out_channels=64, kernel_size=3)
...
#     model = DCNv2(in_channels=32, out_channels=64, kernel_size=3)
#
...
class CAGSNet(nn.Module):
    ...
    def __init__(self, classes=19, M=3, N=21, dropout_flag=False):
        ...
        self.level1_0 = DCNv2(in_channels=3, out_channels=32, stride=2)
        # self.level1_1 = ConvBNPReLU(32, 32, 3, 1)
        self.level1_1 = DCNv2(in_channels=32, out_channels=32, stride=1)

        # self.level1_2 = ConvBNPReLU(32, 32, 3, 1)
        self.level1_2 = DCNv2(in_channels=32, out_channels=32, stride=1)
