...
#     psa = SequentialPolarizedSelfAttention(channel=3)
#     output=psa(input)
#     print(output.shape)
#
# if __name__ == '__main__':
...
#     model = SequentialPolarizedSelfAttention(channel=32)
#
...
class ContextGuidedBlock_Down(nn.Module):
    ...
    def __init__(self, nIn, nOut, dilation_rate=2, reduction=16):
        ...
        self.F_loc = SequentialPolarizedSelfAttention(channel=nOut)
...
class ContextGuidedBlock(nn.Module):
    def __init__(self, nIn, nOut, dilation_rate=2, reduction=16, add=True):
        ...
        self.F_loc = SequentialPolarizedSelfAttention(channel=n)
