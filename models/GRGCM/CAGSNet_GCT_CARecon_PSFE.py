...
#     input_tensor = torch.randn(1, 8, 32, 32)  # 示例批次大小为1，32x32的特征图
#
#     # 打印输入张量的形状
#     print(f'输入张量的形状: {input_tensor.shape}')
#
#     # 实例化 GCT 模块
#     gct = GCT(num_channels=8)
#
#     # 前向传播
...
class ContextGuidedBlock_Down(nn.Module):
    ...
    def __init__(self, nIn, nOut, dilation_rate=2, reduction=16):
        ...
        self.F_loc =  GCT(num_channels=nOut)
