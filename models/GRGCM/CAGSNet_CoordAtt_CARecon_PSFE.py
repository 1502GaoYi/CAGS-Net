...
# Github地址: https://github.com/houqb/CoordAttention
# ---------------------------------------
...
#     block = CoordAtt(48, 48)
#     input = torch.rand(1, 48, 128, 128)
#     output = block(input)
