...
# 项目名称：SCSA: Exploring the Synergistic Effects Between Spatial and Channel Attention
# 项目来源：SCSA: 研究空间注意力与通道注意力之间的协同效应
# 论文地址：https://arxiv.org/pdf/2407.05128

# 项目代码库：https://github.com/HZAI-ZJNU/SCSA
# 欢迎大家关注、支持AI人工智能研究！

"""
2024全球最先进的深度学习模型，全球领先！欢迎参与开源项目，贡献代码、技术方案，欢迎加入AI人工智能研究！
"""
# 以下为代码主体部分
...
class ContextGuidedBlock_Down(nn.Module):
    ...
    def __init__(self, nIn, nOut, dilation_rate=2, reduction=16):
        ...
        self.F_loc = SCSA(dim=nOut, head_num=8, window_size=7)
...
class ContextGuidedBlock(nn.Module):
    def __init__(self, nIn, nOut, dilation_rate=2, reduction=16, add=True):
        ...
        self.F_loc = SCSA(dim=n, head_num=8, window_size=7)
