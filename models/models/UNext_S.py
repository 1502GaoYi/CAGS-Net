...
#https://github.com/yhygao/UTNet/blob/main/model/utnet.py
# EOF
...
if __name__ == "__main__":
    ...
    model = UNext_S(num_classes=1, input_channels=3, deep_supervision=False, img_size=256, patch_size=16, in_chans=3,
                    embed_dims=[32, 64, 128, 512], num_heads=[1, 2, 4, 8], mlp_ratios=[4, 4, 4, 4], qkv_bias=False,
                    norm_layer=torch.nn.LayerNorm, depths=[1, 1, 1], sr_ratios=[8, 4, 2, 1]).cuda()
